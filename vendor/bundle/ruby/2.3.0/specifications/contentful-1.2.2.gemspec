...
Gem::Specification.new do |s|
  ...
  s.require_paths = ["lib"]
  s.authors = ["Contentful GmbH (Jan Lelis)", "Contentful GmbH (Andreas Tiefenthaler)", "Contentful GmbH (David Litvak Bruno)"]
  s.date = "2017-01-03"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<http>, ["< 3.0", "> 0.8"])
      ...
      s.add_dependency(%q<http>, ["< 3.0", "> 0.8"])
